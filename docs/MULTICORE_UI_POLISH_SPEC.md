# Multicore UI Polish — Especificação Visual (SPEC)

## Objectivo

Elevar o Multicore ERP a um nível visual indistinguível de um ERP comercial de topo (Multicore CS, Primavera, Sage).
Intervenção puramente visual — sem alterações a Services, DTOs, repositórios ou regras de negócio.

---

## 1. Tabs com Linha de Acento Multicore (`styleTabbedPaneMulticore`)
...
1. `styleTabbedPaneMulticore` aplica-se a **todos os painéis internos**; a barra de topo mantém `styleTabbedPane`
