# Documentacao Tecnica - Multicore ERP

Este directorio organiza a documentacao que orienta arquitectura, manutencao e agentes de IA.

## Leitura por objectivo

| Quero... | Ler |
|----------|-----|
| Entender os modulos e quem e dono de cada regra | [DOMAIN_MODEL.md](DOMAIN_MODEL.md) |
| Alterar vendas, POS, compras, stock ou salarios | [BUSINESS_FLOWS.md](BUSINESS_FLOWS.md) |
...
Documentacao deve ser curta, normativa e accionavel. Se um ficheiro deixar de orientar decisoes reais, deve ser actualizado ou removido.
