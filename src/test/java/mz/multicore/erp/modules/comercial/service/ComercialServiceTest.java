...
class ComercialServiceTest {
    ...
    private mz.multicore.erp.modules.fiscal.repository.TaxRateRepository taxRateRepository;
    ...
    void setUp() {
        ...
        taxRateRepository = mock(mz.multicore.erp.modules.fiscal.repository.TaxRateRepository.class);
    ...
    private mz.multicore.erp.modules.financeira.model.TreasuryAccount treasuryAccount() {
        mz.multicore.erp.modules.financeira.model.TreasuryAccount account =
                new mz.multicore.erp.modules.financeira.model.TreasuryAccount();
    ...
    private Invoice approvedInvoice(BigDecimal qty) {
        ...
        mz.multicore.erp.modules.comercial.model.InvoiceLine line = new mz.multicore.erp.modules.comercial.model.InvoiceLine();
        line.setProduct(product);
        line.setQuantity(qty);
        line.setUnitPrice(new BigDecimal("100"));
        line.setTaxRate(new BigDecimal("0.16"));
