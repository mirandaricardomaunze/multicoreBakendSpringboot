...
class POSServiceTest {
    ...
    void checkout_numerarioComTroco_calculaTrocoNoPagamento() {
        ...
        org.mockito.ArgumentCaptor<mz.multicore.erp.modules.pos.model.PaymentEntry> captor =
                org.mockito.ArgumentCaptor.forClass(mz.multicore.erp.modules.pos.model.PaymentEntry.class);
        ...
        mz.multicore.erp.modules.pos.model.PaymentEntry entry = captor.getValue();
