package com.phcpro.gui.accounting;

import com.phcpro.architecture.paging.PageResponse;
import com.phcpro.desktop.client.AccountingApiClient;
    ...
    private void openAccountDialog() {
        ...
        dialog.setOnSaveAsync(() -> {
            ...
            SaveAccountRequest request = new SaveAccountRequest(
                    ...
                    com.phcpro.modules.accounting.model.AccountNature.valueOf(String.valueOf(nature.getSelectedItem())),
                    postable.isSelected());
