...
public class ComprasPanel extends JPanel {
    ...
    java.util.List<com.phcpro.modules.purchases.dto.ReorderSuggestionDTO> reorderList = new java.util.ArrayList<>();
    ...
    List<com.phcpro.modules.purchases.dto.PayableDTO> payablesList = new ArrayList<>();
