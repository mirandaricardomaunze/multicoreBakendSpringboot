...
public interface CreditNoteRepository extends JpaRepository<CreditNote, Long> {
    ...
    @Query("SELECT COALESCE(SUM(l.quantity), 0) FROM CreditNoteLine l " +
            ...
            "AND l.creditNote.status <> mz.multicore.erp.modules.comercial.model.NoteStatus.REJECTED " +
            "AND l.creditNote.status <> mz.multicore.erp.modules.comercial.model.NoteStatus.CANCELLED")
