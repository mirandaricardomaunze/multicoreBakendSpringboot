...
final class StockCategoriesPanel {
    ...
    public JPanel buildPanel() {
        ...
        card.add(mz.multicore.erp.gui.components.ClientTablePagination.install(owner.categoriesTable), BorderLayout.SOUTH);
    ...
    private void openCategoryDialog(mz.multicore.erp.modules.comercial.dto.ProductCategoryDTO existing) {
        ...
        dlg.setOnSaveAsync(() -> {
            ...
            var req = new mz.multicore.erp.modules.comercial.dto.CreateProductCategoryRequest(
