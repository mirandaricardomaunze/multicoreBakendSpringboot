...
final class StockInventoryCountActions {
    ...
    public void openPhysicalInventoryDialog() {
        ...
        final java.util.List<mz.multicore.erp.modules.inventory.dto.InventoryCountDTO> rows = new ArrayList<>();
    ...
    private void showCountSession(mz.multicore.erp.modules.inventory.dto.InventoryCountDTO session) {
