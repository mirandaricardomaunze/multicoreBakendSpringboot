...
final class PosPaymentDialog {
    ...
    static mz.multicore.erp.modules.pos.dto.PosPaymentRequest show(BigDecimal total, Long accountId) {
        ...
        mz.multicore.erp.modules.pos.dto.PosPaymentRequest[] result = {null};
        boolean ok = new ModernFormDialog(UIHelper.mainWindow, "Pagamento", "fas-money-bill-wave",
                ...
                .setOnSave(() -> {
                    ...
                    if (methodIdx == 0) {
                        ...
                        result[0] = new mz.multicore.erp.modules.pos.dto.PosPaymentRequest("CASH", total, tendered, null, null);
                    } else {
                        ...
                        result[0] = new mz.multicore.erp.modules.pos.dto.PosPaymentRequest(
