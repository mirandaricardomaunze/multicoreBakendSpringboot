...
public class ClientVersionInterceptor implements HandlerInterceptor {
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
        ...
        Long companyId = mz.multicore.erp.architecture.security.CurrentUserContext.findCurrentCompanyId();
        if (companyId == null) return;
        registry.record(companyId, clientVersion,
                mz.multicore.erp.architecture.security.CurrentUserContext.findCurrentUser() == null
                        ? null : mz.multicore.erp.architecture.security.CurrentUserContext.getUsername());
    }
