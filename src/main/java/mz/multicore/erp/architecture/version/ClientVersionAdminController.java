...
public class ClientVersionAdminController {
    ...
    private final mz.multicore.erp.modules.platform.service.PlatformCompanyService platformCompanyService;

    public ClientVersionAdminController(
            ClientVersionRegistry registry,
            mz.multicore.erp.modules.platform.service.PlatformCompanyService platformCompanyService) {
    ...
    public ResponseEntity<List<ClientVersionUsageDTO>> listUsage() {
        ...
        java.util.Map<Long, String> names = platformCompanyService.listCompanies().stream()
                .collect(java.util.stream.Collectors.toMap(
                        mz.multicore.erp.modules.platform.dto.PlatformCompanyDTO::id,
                        mz.multicore.erp.modules.platform.dto.PlatformCompanyDTO::name,
                        (a, b) -> a));
